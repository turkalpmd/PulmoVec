...
# Data paths (can be overridden via PULMOVEC_DATA_DIR)
DATA_DIR = Path(os.getenv("PULMOVEC_DATA_DIR", PROJECT_ROOT / "data"))
CSV_PATH = DATA_DIR / "SPRSound_Event_Level_Dataset_CLEAN.csv"
ENSEMBLE_CSV_PATH = DATA_DIR / "SPRSound_Event_Level_Ensemble_Dataset.csv"

# WAV root directory: checks PULMOVEC_WAV_DIR -> DATA_DIR / "wavfiles" -> PROJECT_ROOT / "SPRSound-main"
_default_wav_dir = DATA_DIR / "wavfiles"
if not _default_wav_dir.exists() and (PROJECT_ROOT / "SPRSound-main").exists():
    _default_wav_dir = PROJECT_ROOT / "SPRSound-main"
WAV_ROOT_DIR = Path(os.getenv("PULMOVEC_WAV_DIR", _default_wav_dir))

# Model save directory (can be overridden via PULMOVEC_MODEL_DIR)
MODEL_DIR = Path(os.getenv("PULMOVEC_MODEL_DIR", PROJECT_ROOT / "models"))
try:
