#!/usr/bin/env python3
"""
SPRSound Event-Level Dataset Generator (DEDUPLICATED VERSION)

Bu script duplikasyonları önleyerek temiz bir CSV oluşturur.
...
def main():
    print("="*80)
    print("SPRSound Event-Level Dataset Generator (CLEAN - NO DUPLICATES)")
    print("="*80)
    ...
    # Önce SPRSound-main (daha düzenli), sonra SPRSound'dan eksik olanlar
    json_directories = [
    ...
    # CSV'ye yaz
    if all_events:
        output_file = os.path.join(base_dir, 'SPRSound_Event_Level_Dataset_CLEAN.csv')
        
        print(f"\n💾 CLEAN CSV oluşturuluyor: {output_file}")
        ...
        # İstatistikler
        print("\n" + "="*80)
        print("📊 İSTATİSTİKLER (DUPLIKASYONSUZ)")
        print("="*80)
        ...
        print("\n" + "="*80)
        print("✅ İŞLEM TAMAMLANDI - DUPLIKASYONSUZ!")
        print("="*80)
